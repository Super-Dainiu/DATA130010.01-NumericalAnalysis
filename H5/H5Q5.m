x=[1 0 -1 0 1 0 -1]; y=[1 2 1 0 -1 -2 -1]; n=numel(x);
t(1)=0;
for i=2:n
...
%k1 for x
beta=2./h; eta1=6*g1./(h.^2); b1=[eta1(1),eta1(2:n-1)+eta1(1:n-2),eta1(n-1)]';
A=diag([2*beta(1),2*beta(1:n-2)+2*beta(2:n-1),2*beta(n-1)])+diag(beta,-1)+diag(beta,1);
k1=A\b1;
%k2 for y
eta2=6*g2./(h.^2); b2=[eta2(1),eta2(2:n-1)+eta2(1:n-2),eta2(n-1)]';
k2=A\b2;
for i=1:n-1
